            ...
            <div class="float-right">
                ...
                <div class="dropdown d-inline-block">
                    <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        @else
                        <img class="rounded-circle header-profile-user" src="{{ url('/images/icons/people.png') }}" alt="Header Avatar">
                        @endif
            ...
            <div>
                ...
                <div class="navbar-brand-box">
                    <a href="index" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="images/icons/logo.png" alt="" height="20">
                        </span>
                        <span class="logo-lg">
                            <img src="images/icons/logo.png" alt="" height="17">
                        </span>
                    </a>
                    ...
                    <a href="index" class="logo logo-light">
                        ...
                        <span class="logo-lg">
                            <img src="images/icons/logo.png" alt="" height="19">
                        </span>
                    </a>
                </div>
