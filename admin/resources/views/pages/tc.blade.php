...
<body>
    ...
    <p>
        ...
        to it, still belong to PT. Impian Jadi Nyata.
    </p>
    <p>
        PT. Impian Jadi Nyata is committed to ensuring that the app is
    ...
    <p>
        The Pityu app stores and processes personal data that
        ...
        that the Pityu app won’t work properly or at all.
    </p>
    <div>
        <p>
        ...
        <ul>
            ...
            <li><a href="https://fabric.io/terms/fabric" target="_blank" rel="noopener noreferrer">Fabric</a></li>
            <!---->
            <!---->
            <!---->
            <!---->
    ...
    <p>
        ...
        PT. Impian Jadi Nyata will not take responsibility for. Certain
        functions of the app will require the app to have an active
        internet connection. The connection can be Wi-Fi, or provided
        by your mobile network provider, but PT. Impian Jadi Nyata
    ...
    <p>
        Along the same lines, PT. Impian Jadi Nyata cannot always take
        responsibility for the way you use the app i.e. You need to
        make sure that your device stays charged – if it runs out of
        battery and you can’t turn it on to avail the Service,
        PT. Impian Jadi Nyata cannot accept responsibility.
    </p>
    <p>
        With respect to PT. Impian Jadi Nyata’s responsibility for your
        use of the app, when you’re using the app, it’s important to
        bear in mind that although we endeavour to ensure that it is
        updated and correct at all times, we do rely on third parties
        to provide information to us so that we can make it available
        to you. PT. Impian Jadi Nyata accepts no liability for any
    ...
    <p>
        ...
        using the app. PT. Impian Jadi Nyata does not promise that it
    ...
    <p>
        ...
        at developer@impianjadinyata.com.
    </p>
