...
<body>
    ...
    <p>
        PT. Impian Jadi Nyata built the Pityu app as
        a Free app. This SERVICE is provided by
        PT. Impian Jadi Nyata at no cost and is intended for use as
        is.
    </p>
    <p>
    ...
    <p>
        ...
        Pityu unless otherwise defined in this Privacy Policy.
    </p>
    <p><strong>Information Collection and Use</strong></p>
    <p>
        For a better experience, while using our Service, we
        may require you to provide us with certain personally
        identifiable information, including but not limited to Bima Pangestu. The information that
    ...
    <div>
        ...
        <ul>
            ...
            <li><a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">Fabric</a></li>
            <!---->
            <!---->
            <!---->
            <!---->
    ...
    <p>
        ...
        Privacy Policy, do not hesitate to contact us at developer@impianjadinyata.com.
    </p>
